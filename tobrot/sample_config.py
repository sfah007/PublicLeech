...
class Config:
    ...
    TG_BOT_TOKEN = get_config("1640796806:AAEVKLVqOVK98wsnUT440SoEFXtsWtyjohQ", should_prompt=True)
    # The Telegram API things
    APP_ID = int(get_config("2180427", should_prompt=True))
    API_HASH = get_config("b52730e42aabdb05615832d48c702ce6", should_prompt=True)
